...
data NemTransaction = NemTransaction
	...
	, nt_creationFeeSink :: !(Maybe Int64)
	, nt_delta :: !(Maybe Int64)
	, nt_otherAccount :: !(Maybe B.ByteString)
	, nt_rentalFee :: !(Maybe Int64)
	, nt_rentalFeeSink :: !(Maybe B.ByteString)
...
instance J.FromJSON NemTransaction where
	parseJSON = J.withObject "nem transaction" $ \fields -> NemTransaction
		...
		<*> (fields J..:? "delta")
		<*> (traverse decodeHexBytes =<< fields J..:? "otherAccount")
		<*> (fields J..:? "rentalFee")
		<*> (traverse decodeHexBytes =<< fields J..:? "rentalFeeSink")
		<*> (fields J..:? "newPart")
		<*> (fields J..:? "parent")
		<*> (fields J..:? "amount")
